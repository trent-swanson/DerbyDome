    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.tag == "Player")
        {
            ...
            if (other.gameObject.tag == "Player" && bumperDamage == false)
            {
                ...
                {
                    //Checks if the ATTACKING player is faster than 80% of the other player
        ...
        //Bumper damage
        //The other below is the ATTACKING players bumper
        if (other.gameObject.tag == "Front Bumper")
        {
            ...
            {
                //The timer is a stopper to make sure the bumper dosnt run its damage twice
                timer = 0;
